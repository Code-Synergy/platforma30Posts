...
from models import Gepeto_Zoe_V3, db, clientes, pedido, ordens_de_servico, negocios, send_form, validar_id_form, workflow, legendas, tipo_cliente, user
...
app.register_blueprint(Gepeto_Zoe_V3.zoe_bp, url_prefix='/zoe')
